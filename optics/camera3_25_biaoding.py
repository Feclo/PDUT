...
class PSFFixedCamera(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.psf = self.add_weight(name="PSF", shape=(1, 512, 512, 25),
                                   ...
                                   initializer=tf.constant_initializer(
                                       ...
                                       value=sio.loadmat(
                                           "psf_crop_all_512_25_430to670_cap_plan_metasurface_filter10_nomask_250703.mat")[
                                           "psf_crop_all_512_25_430to670_filter"]),
    ...
    def call(self, inputs, training=None, testing=None, **kwargs):
        ...
        from optics.sensor_srfs_25 import simulated_rgb_camera_spectral_response_function
