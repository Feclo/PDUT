...
from optics.sensor_srfs_25 import simulated_rgb_camera_spectral_response_function_lost
...
def save_hyper_to_tiled_rgb_file(hyper_image, save_path, with_hyper_tiles=False, with_rgb=True, norm=False):
    ...
    if with_rgb:
        rgb = simulated_rgb_camera_spectral_response_function_lost(hyper_image)
